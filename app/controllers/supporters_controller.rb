...
before_filter :require_login
  ...
  def create
    ...
    respond_to do |format|
      if @supporter.save
        format.html { redirect_to supporters_path, notice: 'Supporter was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @supporter.update(supporter_params)
        format.html { redirect_to supporters_path, notice: 'Supporter was successfully updated.' }
  ...
  private
    ...
    def supporter_params
      params.require(:supporter).permit(:firstname, :lastname, :group, :individual, :elected, :rank, :organization, :title)
    end
end
